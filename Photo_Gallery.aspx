<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Photo_Gallery.aspx.cs" Inherits="Photo_Gallery" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Photo Gallery - National Education Enrichment in Villages (NEEV)</title>
...
<body>
    <form id="form1" runat="server">
		...
		<ul id="Main_Content">
			...
			<li class="not-on-phone active"><a href="Photo_Gallery" class="click-on hvr-underline-from-center">PHOTO GALLERY</a></li>
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-md-12 text-center">
					<h3 class="default-h"><i class="fa fa-picture-o"></i><br />- Chrismas'18 -</h3>
					<div class="g-outer">
						<div class="g-in">
							<img src="Images/Chrismas18/ch1-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/Chrismas18/ch2-min.jpg" />
							<img src="Images/Chrismas18/ch5-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/Chrismas18/ch3-min.jpg" />
							<img src="Images/Chrismas18/ch6-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/Chrismas18/ch4-min.jpg" />
						</div>
					</div>
					<br /><h3 class="default-h"><i class="fa fa-picture-o"></i><br />- Lalkurti Slum Class -</h3>
					<div class="g-outer">
						<div class="g-in">
							<img src="Images/LalSlumClass/lsc1-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/LalSlumClass/lsc2-min.jpg" />
							<img src="Images/LalSlumClass/lsc3-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/LalSlumClass/lsc4-min.jpg" />
							<img src="Images/LalSlumClass/lsc5-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/LalSlumClass/lsc6-min.jpg" />
						</div>
					</div>
					<br /><h3 class="default-h"><i class="fa fa-picture-o"></i><br />- Learn By Doing -</h3>
					<div class="g-outer">
						<div class="g-in">
							<img src="Images/LearningByDoing/ld1-min.jpg" />
							<img src="Images/LearningByDoing/ld2-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/LearningByDoing/ld3-min.jpg" />
							<img src="Images/LearningByDoing/ld4-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/LearningByDoing/ld5-min.jpg" />
							<img src="Images/LearningByDoing/ld6-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/LearningByDoing/ld7-min.jpg" />
						</div>
					</div>
					<br /><h3 class="default-h"><i class="fa fa-picture-o"></i><br />- Monthly Tests -</h3>
					<div class="g-outer">
						<div class="g-in">
							<img src="Images/MonthlyTests/mt1-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/MonthlyTests/mt2-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/MonthlyTests/mt3-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/MonthlyTests/mt4-min.jpg" />
						</div>
					</div>
					<br /><h3 class="default-h"><i class="fa fa-picture-o"></i><br />- Sapling & Quizes -</h3>
					<div class="g-outer">
						<div class="g-in">
							<img src="Images/SaplingQuizes/sq1-min.jpg" />
							<img src="Images/SaplingQuizes/sq2-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/SaplingQuizes/sq3-min.jpg" />
							<img src="Images/SaplingQuizes/sq4-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/SaplingQuizes/sq5-min.jpg" />
							<img src="Images/SaplingQuizes/sq6-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/SaplingQuizes/sq7-min.jpg" />
						</div>
					</div>
					<br /><h3 class="default-h"><i class="fa fa-picture-o"></i><br />- Shoes Distribution -</h3>
					<div class="g-outer">
						<div class="g-in">
							<img src="Images/ShoesDist/sd1-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/ShoesDist/sd2-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/ShoesDist/sd4-min.jpg" />
							<img src="Images/ShoesDist/sd5-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/ShoesDist/sd6-min.jpg" />
						</div>
					</div>
				</div>
			</div>
