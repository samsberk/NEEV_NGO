<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shoe_Distribution19.aspx.cs" Inherits="Shoe_Distribution19" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Shoes Distribution - Events - National Education Enrichment in Villages (NEEV)</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="background:brown;padding-bottom:30px;">
			<div class="row text-center">
				...
				<div class="col-md-6">
					<h3 class="default-h" style="color:white;"><i class="fa fa-child"></i><br />- Shoes Distribution -</h3>
					<p class="default-p" style="color:white;">
						For an underprivileged child in villages, the path to school is arduous – from the tropical heat to rubble
						on the streets to stagnant water following the monsoons breeding disease – every step is fraught with danger,
						quite literally. These children are most often barefoot, while a few wear ill-fitting second-hand footwear or
						shoes that are fraying to the point of being threadbare from constant use. On <b>1st February 2019</b>, YOU WE CAN
						came forward and distributed shoes and help our NEEV’s champs.
						Team from U we can, modinagar visited the slum class and distributed 40 pairs of shoes to the children of the classes,
						also they distributed tooth brushes, and eatables to all the children. They have provided 240+ shoes to the children
						in all the udgam neev classes. U guys have always been a support to NEEV and Udgam and we are always delighted with your
						association and its nice to see you guys always full of energy.
						We thank all the members for coming. And last but not the least we thank all our hardworking volunteers for their constant support always.
			...
			<div class="row">
				...
				<h3 class="default-h" style="color:white;">- Glimpse -</h3>
					<div class="loop owl-carousel owl-theme">
						<div class="item">
							<img src="Images/ShoesDist/sd1-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/ShoesDist/sd2-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/ShoesDist/sd4-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/ShoesDist/sd5-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/ShoesDist/sd6-min.jpg" style="width:100%;" />
						</div>
