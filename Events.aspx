...
<head runat="server">
    <title>Events - National Education Enrichment in Villages (NEEV)</title>
...
<body>
    <form id="form1" runat="server">
		...
		<ul id="Main_Content">
			...
			<li class="not-on-phone active"><a href="Events" class="click-on hvr-underline-from-center">EVENTS</a></li>
		...
		<div class="panel-body" style="background:brown;padding-bottom:30px;">
			<div class="row text-center">
				<h3 class="default-h" style="color:white;"><i class="fa fa-calendar-check"></i><br />- Upcoming Events -</h3>
				...
				<div class="col-sm-4">
					...
					<div class="card-outer">
						<div class="card-outer-in">
							<img src="Images/Party-min.jpg" />
						</div>
						<h3 class="default-h">Reveal Soon</h3>
						<p class="default-p">
		...
		<div class="panel-body">
			<div class="row">
				...
				<div class="col-sm-8 text-center">
					<h3 class="default-h"><i class="fa fa-book"></i><br />- NEEV Classes -</h3>
					<p class="default-p">
						...
						<br />
						<b style="color:#1A2E35;">“Education is a human right with immense power to transform. On its foundation rest the cornerstones of freedom, democracy and sustainable human development.”</b><br />
					...
					<a href="NEEV_Classes" class="big-link hvr-icon-drop hvr-outline-in hvr-buzz-out">Learn More &nbsp;<i class="fa fa-link hvr-icon"></i></a><br /><br />
				</div>
				<div class="col-sm-2"></div>
			</div>
		</div>
		...
		<div class="panel-body section-box" style="background:brown;">
			<div class="row text-center">
				<h3 class="default-h" style="color:white;"><i class="fa fa-arrows"></i><br />- Our Activities -</h3>
				<div class="col-sm-2"></div>
				<div class="col-sm-8">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="row">
									...
									<div class="col-sm-6">
											<h3>Slum Classes</h3>
											<a href="Lalkruti_Slum_Class">Learn More</a>
									</div>
								</div>
							</div>
							<div class="item">
								<img src="Images/dummy-banner.jpg"/>
								<div class="carousel-caption revent-slider">
							...
							<div class="item">
								<img src="Images/dummy-banner.jpg"/>
								<div class="carousel-caption revent-slider">
									<h3>Summer and Winter Campus</h3>
									<p>Upstream seeks and builds relationships with individuals who are making a difference in their communities. By finding those who are already creating change, we are deepening impact instead of duplicating it.</p>
									<a href="#">Learn More</a>
								</div>
							</div>
							...
							<div class="item">
								<img src="Images/dummy-banner.jpg"/>
								<div class="carousel-caption revent-slider">
									<h3>Distribution of Stationaries and Books</h3>
									<p>Upstream seeks and builds relationships with individuals who are making a difference in their communities. By finding those who are already creating change, we are deepening impact instead of duplicating it.</p>
									<a href="#">Learn More</a>
								</div>
							</div>
							<div class="item">
								<img src="Images/dummy-banner.jpg"/>
								<div class="carousel-caption revent-slider">
									<h3>Distribution of Clothes and Shoes</h3>
									<p>Upstream seeks and builds relationships with individuals who are making a difference in their communities. By finding those who are already creating change, we are deepening impact instead of duplicating it.</p>
									<a href="#">Learn More</a>
								</div>
							</div>
