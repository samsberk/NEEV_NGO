<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Media_Coverage.aspx.cs" Inherits="Media_Coverage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Media Coverage - National Education Enrichment in Villages (NEEV)</title>
...
<body>
    <form id="form1" runat="server">
		...
		<ul id="Main_Content">
			...
			<li class="not-on-phone active"><a href="Media_Coverage" class="click-on hvr-underline-from-center">MEDIA COVERAGE</a></li>
		...
		<div class="panel-body" style="background:brown;padding-bottom:30px;">
			<div class="row">
				<div class="col-md-12 text-center">
					<h3 class="default-h" style="color:white;"><i class="fa fa-video"></i><br />- Media Coverage -</h3>
					<div class="g-outer">
						<div class="g-in">
							<img src="Images/MediaCoverage/mc1-min.jpg" />
							<img src="Images/MediaCoverage/mc2-min.jpg" />
							<img src="Images/MediaCoverage/mc3-min.jpg" />
							<img src="Images/MediaCoverage/mc4-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/MediaCoverage/mc5-min.jpg" />
							<img src="Images/MediaCoverage/mc6-min.jpg" />
							<img src="Images/MediaCoverage/mc7-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/MediaCoverage/mc10-min.jpg" />
							<img src="Images/MediaCoverage/mc11-min.jpg" />
							<img src="Images/MediaCoverage/mc12-min.jpg" />
							<img src="Images/MediaCoverage/mc9-min.jpg" />
							<img src="Images/MediaCoverage/mc8-min.jpg" />
						</div>
						<div class="g-in">
							<img src="Images/MediaCoverage/mc15-min.jpg" />
							<img src="Images/MediaCoverage/mc16-min.jpg" />
							<img src="Images/MediaCoverage/mc17-min.jpg" />
							<img src="Images/MediaCoverage/mc18-min.jpg" />
						</div>
					</div>
				</div>
			</div>
