<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Learning_By_Doing.aspx.cs" Inherits="Learning_By_Doing" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Learning By Doing - Events - National Education Enrichment in Villages (NEEV)</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="background:brown;padding-bottom:30px;">
			<div class="row text-center">
				...
				<div class="col-md-6">
					<h3 class="default-h" style="color:white;"><i class="fa fa-child"></i><br />- Learning By Doing -</h3>
					<p class="default-p" style="color:white;">
						...
						They took a special session for the all the volunteers and teachers to make them aware about the same.
						We thank the team for coming to the classes and we together had a great time and learnt a lot from u guys.
						U guys are an inspiration for all of us. Great going, we look forward to our further association.
					</p>
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
				...
				<h3 class="default-h" style="color:white;">- Glimpse -</h3>
					<div class="loop owl-carousel owl-theme">
						<div class="item">
							<img src="Images/LearningByDoing/ld1-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LearningByDoing/ld2-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LearningByDoing/ld3-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LearningByDoing/ld4-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LearningByDoing/ld5-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LearningByDoing/ld6-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LearningByDoing/ld7-min.jpg" style="width:100%;" />
						</div>
