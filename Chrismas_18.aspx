<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chrismas_18.aspx.cs" Inherits="Chrismas_18" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Chrismas'18 - Events - National Education Enrichment in Villages (NEEV)</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="background:brown;padding-bottom:30px;">
			<div class="row text-center">
				...
				<div class="col-md-6">
					<h3 class="default-h" style="color:white;"><i class="fa fa-child"></i><br />- Chrismas'18 -</h3>
					<p class="default-p" style="color:white;">
						On Christmas <b>25th December 2018</b>, we decided to make the festival special to them. 
						We respect varying religions and cultures and we work in communities where our
						mission can contribute to develop the village children.<br />We invited <b>Dr. Updesh
						Verma</b> to give blessing to our champs and make them aware about their health.
					</p>
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
				...
				<h3 class="default-h" style="color:white;">- Glimpse -</h3>
					<div class="loop owl-carousel owl-theme">
						<div class="item">
							<img src="Images/Chrismas18/ch1-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/Chrismas18/ch2-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/Chrismas18/ch3-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/Chrismas18/ch4-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/Chrismas18/ch5-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/Chrismas18/ch6-min.jpg" style="width:100%;" />
						</div>
