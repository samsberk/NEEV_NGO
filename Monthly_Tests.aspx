<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monthly_Tests.aspx.cs" Inherits="Monthly_Tests" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Monthly Tests - Events - National Education Enrichment in Villages (NEEV)</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="background:brown;padding-bottom:30px;">
			<div class="row text-center">
				...
				<div class="col-md-6">
					<h3 class="default-h" style="color:white;"><i class="fa fa-child"></i><br />- Monthly Tests -</h3>
					<p class="default-p" style="color:white;">
						...
						any nation, destroy its education system, the nation will destroy itself automatically.   Our ancient Indian
						culture was very rich in education. Lots of people from around the world come to India to have education. But
						after the Britishers came into power, they have destroyed out education system. The made public and private
						schools whereas previously we have only one strong system of education. We decided to make children strong in
						Studies and educational activities so we schedule a monthly test and activities classes for Children of NEEV.
						Test have held in every last week of the month regularly. 
					</p>
				</div>
				<div class="col-md-3"></div>
			</div>
