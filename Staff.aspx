...
<head runat="server">
    <title>Staff Login - National Education Enrichment in Villages (NEEV)</title>
...
<body>
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="padding-top:10px;min-height:10vh;background:brown;">
			<div class="row">
				<h3 class="default-h text-center" style="color:white;"><i class="fa fa-sign-in"></i><br />- Staff Login -</h3>
				<div class="col-md-4"></div>
				<div class="col-md-4">
					<div class="section-box-in loginbox" style="box-shadow:0px 1px 10px brown;border-radius:10px;padding:20px 20px;border:1px solid gray;background:white;">
						<label class="txt-box-label">User ID :</label>
						<asp:TextBox runat="server" ID="mailtxt" TextMode="Email" MaxLength="30" Placeholder="Enter User ID" CssClass="txt-box" style="text-transform:unset;"></asp:TextBox>
						<label class="txt-box-label">Password :</label>
						<asp:TextBox runat="server" ID="passtxt" TextMode="Password" MaxLength="30" Placeholder="Enter Password" CssClass="txt-box" style="text-transform:unset;"></asp:TextBox><br /><br />
						
						<asp:Button runat="server" ID="loginbtn" CssClass="btn btn-success" Text="Sign In" OnClick="loginbtn_Click"/>
						<button type="button" id="forpasslink" class="btn btn-info pull-right">Forgot Password</button>
						<br />
					</div>
					<div class="section-box-in forpassbox" style="box-shadow:0px 1px 10px brown;border-radius:10px;padding:20px 20px;border:1px solid gray;background:white;">
						<label class="txt-box-label">Registered Email ID :</label>
						<asp:TextBox runat="server" ID="fmailtxt" TextMode="Email" MaxLength="30" Placeholder="Enter Registered Email ID" CssClass="txt-box" style="text-transform:unset;"></asp:TextBox><br /><br />
						<asp:Button runat="server" ID="fbtn" CssClass="btn btn-success" Text="Next" OnClick="fbtn_Click"/>
						<button type="button" id="loginlink" class="btn btn-info pull-right">Go for Login</button>
						<br />
					</div>
				</div>
				<div class="col-md-4"></div>
	...
	<script type="text/javascript">
		if ($("#informer").text() === "InvalidUserID") {
			$(".notcon").show();
			window.setTimeout(function () {
				$(".notification-box").addClass("showNotice");
			}, 2000);
		}
		else if ($("#informer").text() === "PasswordSent") {
			$(".notcon").show();
			window.setTimeout(function () {
				$(".notification-box").addClass("showNotice");
			}, 2000);
