<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lalkurti_Slum_Class.aspx.cs" Inherits="Lalkurti_Slum_Class" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Lalkurti Slum Class - Events - National Education Enrichment in Villages (NEEV)</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="background:brown;padding-bottom:30px;">
			<div class="row text-center">
				...
				<div class="col-md-6">
					<h3 class="default-h" style="color:white;"><i class="fa fa-child"></i><br />- Lalkurti Slum Class -</h3>
					<p class="default-p" style="color:white;">
						...
						visited the NEEV village classes  from delhi and they organised a special workshop for the kids. Plantation of saplings
						and quiz was also organised on environment.  They provided children with goodies and eatables on this occasion. All kids
						of 5 village NEEV classes were present there and all are very happy. Thanks to all the members for coming and interactive
						session with kids is much appreciated and we will together work more on the kids and try to cope up with loop holes. Thanks
						for your guidance and we look forward to our further association.
			...
			<div class="row">
				...
				<h3 class="default-h" style="color:white;">- Glimpse -</h3>
					<div class="loop owl-carousel owl-theme">
						<div class="item">
							<img src="Images/LalSlumClass/lsc1-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LalSlumClass/lsc2-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LalSlumClass/lsc3-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LalSlumClass/lsc4-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LalSlumClass/lsc5-min.jpg" style="width:100%;" />
						</div>
						<div class="item">
							<img src="Images/LalSlumClass/lsc6-min.jpg" style="width:100%;" />
						</div>
